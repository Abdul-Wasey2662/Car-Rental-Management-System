<html>
  ...
  <head>
    <title> customer Signup | Peshawar Car Rental </title>
  </head>
  <?php session_start(); ?>
...
$daily_rent = $conn->real_escape_string($_POST['daily_rent']);
//$non_daily_rent = $conn->real_escape_string($_POST['non_daily_rent']);
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_name,car_nameplate,car_img,daily_rent,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','".$target_path. "','" . $daily_rent . "','" . $car_availability ."')";
        $success = $conn->query($query);
...
// Taking vehicle_id from cars

$query1 = "SELECT vehicle_id from cars where car_nameplate = '$car_nameplate'";
...
$query2 = "INSERT into clientcars(vehicle_id,client_username) values('" . $vehicle_id ."','" . $_SESSION['login_client'] . "')";
