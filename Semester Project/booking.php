...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h2 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Rent your car here </h2><br>

        <?php
        $vehicle_id = $_GET["id"];
        $sql1 = "SELECT * FROM cars WHERE vehicle_id = '$vehicle_id'";
          ...
          <div ng-switch-default>
                ...
                <h5>Fare: <h5>    
                    ...
                    <div ng-switch-when="ac">
                     <div class="form-group"> 
                <h5>Fare: <?php echo("₹" . $ac_price . "/km and ₹" . $daily_rent . "/day");?><h5>    
                </div>    
                     </div>
                     <div ng-switch-when="non_ac">
                      <div class="form-group"> 
                <h5>Fare: <?php echo("₹" . $non_ac_price . "/km and ₹" . $non_daily_rent . "/day");?><h5>    
                < </div>   
                     </div>
        </div>-->
         ...
         <h5> Choose charge type:  &nbsp;
            ...
            <br><br>
                ...
                <select name="driver_id_from_dropdown" ng-model="myVar1">
                        <?php
                        $sql2 = "SELECT * FROM driver d WHERE d.driver_availability = 'yes' AND d.client_username IN (SELECT cc.client_username FROM clientcars cc WHERE cc.vehicle_id = '$vehicle_id')";
                ...
                <?php
                        $sql3 = "SELECT * FROM driver d WHERE d.driver_availability = 'yes' AND d.client_username IN (SELECT cc.client_username FROM clientcars cc WHERE cc.vehicle_id = '$vehicle_id')";
                ...
                <input type="hidden" name="hidden_carid" value="<?php echo $vehicle_id; ?>">
