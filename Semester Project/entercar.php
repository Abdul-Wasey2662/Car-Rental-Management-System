    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="daily_rent" name="daily_rent" placeholder="Rent per day (in rupees)" required>
          </div>

         <!-- <div class="form-group">
            <input type="text" class="form-control" id="non_daily_rent" name="non_daily_rent" placeholder="Non-AC Fare per day (in rupees)" required>
          </div>-->
...
$sql = "SELECT * FROM cars WHERE vehicle_id IN (SELECT vehicle_id FROM clientcars WHERE client_username='$user_check');";
