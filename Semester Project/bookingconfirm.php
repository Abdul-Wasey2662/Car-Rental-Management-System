...
<?php
    ...
    $vehicle_id = $conn->real_escape_string($_POST['hidden_carid']);
    ...
    $sql0 = "SELECT * FROM cars WHERE vehicle_id = '$vehicle_id'";
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedcars(customer_username,vehicle_id,driver_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status) 
    VALUES('" . $customer_username . "','" . $vehicle_id . "','" . $driver_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "')";
    $result1 = $conn->query($sql1);

    $sql2 = "UPDATE cars SET car_availability = 'no' WHERE vehicle_id = '$vehicle_id'";
    $result2 = $conn->query($sql2);

    $sql3 = "UPDATE driver SET driver_availability = 'no' WHERE driver_id = '$driver_id'";
    $result3 = $conn->query($sql3);

    $sql4 = "SELECT * FROM  cars c, clients cl, driver d, rentedcars rc WHERE c.vehicle_id = '$vehicle_id' AND d.driver_id = '$driver_id' AND cl.client_username = d.client_username";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for visiting PESHAWAR Car Rental! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: green;">Your booking has been received and placed into our order processing system.</h3>
                <br>
